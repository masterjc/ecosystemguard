 ...
 * @version $Revision$
 */
public enum H264Resolution implements Resolution {
	...
	private H264Resolution(int xResolution, int yResolution, String resolutionAbbreviation) {
		xRes = xResolution;
		yRes = yResolution;
	...
	public static Resolution parseResolution(String abbreviation) throws Exception {
		H264Resolution[] resolutions = H264Resolution.values();
